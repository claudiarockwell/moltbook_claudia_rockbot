# LinkedIn Follow-Up Sequence - RoseVision CAD Studio

## Day 0: Connection Accepted - Initial Message
...
### For Engineering/Automation Leaders
```
Thanks for connecting, {{first_name}}!
...
Quick story from a molding shop similar to {{company}} —

They were dealing with:
• Vision system breaking every new SKU
• Manual inspectors missing 5-10% of defects
• 3-week delay getting inspection ready for new tools

After switching to CAD-based inspection:
• Models ready before first shot
...
• 2 hours to generate inspection from CAD
...
• 100% inline detection at 50+ parts/minute
• Catches porosity, flash, and dimensional issues
• Integrated with their reject chute automatically
...
## Day 14: Soft Ask for Discovery Call
...
**→ Move to "Nurture" in Monday.com with 90-day follow-up**
...
Or just send a few times that work and I'll send an invite.

Looking forward to it!

Duncan
```
**→ Update Monday.com: "Discovery Call Scheduled"**
...
Duncan
```
**→ Update Monday.com: "Nurture" with specific follow-up date**
...
Duncan
```
**→ Ask for referral, add new contact if provided**
...
Duncan
```
**→ Update Monday.com: "Not Interested"**

---

## Qualification Questions (for Discovery Call)

When scheduling or during initial call, try to learn:

1. **Process:** What manufacturing processes do you run?
2. **Volume:** What's your daily/weekly part volume?
3. **Current inspection:** How do you detect defects today?
4. **Pain:** What's your biggest quality challenge right now?
5. **Scrap:** What's your current scrap/reject rate?
6. **Timeline:** Any new products or lines launching soon?
7. **Decision:** Who else would evaluate a solution like this?
8. **Budget:** Is there budget allocated for quality automation?
...
| Variable | Source |
|----------|--------|
| `{{first_name}}` | LinkedIn profile |
| `{{company}}` | LinkedIn profile |
| `{{process}}` | CNC, molding, casting, stamping, additive |
| `{{industry}}` | automotive, aerospace, medical, etc. |
| `{{department}}` | Quality, Engineering, Operations |
| `{{pain_point_1}}` | From research or conversation |
| `{{pain_point_2}}` | From research or conversation |
| `{{their_challenge}}` | Specific issue they mentioned |
| `{{calendly_link}}` | Your booking link |
| `{{timeframe}}` | "Q2", "after your launch", etc. |
